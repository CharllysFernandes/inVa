 ...
 */
function matchesUrl(savedUrl, currentUrl) {
  try {
...
async function setupTextarea(
  ...
  // Salvar com debounce
  const saveComment = async (reason) => {
    try {
 ...
 */
async function injectElement(savedUrl) {
